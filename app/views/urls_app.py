...
from app.views.app.coins.add_coin_page.add_coin_view import add_coin_page_view, coin_added_success
...
urlpatterns = [
    ...
    path('coin-added-success/', coin_added_success, name='coin_added_success'),
